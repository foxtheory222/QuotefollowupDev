...
- it is easy to think changes are “saved in the repo” when they are only in the workspace
...
- it did not fall back to the SA1300 workbook’s Month-End Plan value
...
- treat “new month without pre-seeded archive row” as a standard case, not an edge case
...
- broad “replace the whole SA1300 branch from canonical” repairs are unsafe unless the canonical workflow itself validates against the live action graph
