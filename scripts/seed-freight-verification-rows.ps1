...
$result = [ordered]@{
  ...
  records = $results
  portal_url = ("https://operationhub.powerappsportals.com/southern-alberta/4171-calgary/detail/?view=freight-worklist&search=" + [uri]::EscapeDataString($portalReference))
  archive_url = ("https://operationhub.powerappsportals.com/southern-alberta/4171-calgary/detail/?view=freight-worklist&search=" + [uri]::EscapeDataString($archiveReference))
}
