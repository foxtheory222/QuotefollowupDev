...
$flowCatalog = @(
  [pscustomobject]@{ BranchCode = "4171"; DisplayName = "4171-BackOrder-Update-ZBO"; WorkflowId = "<GUID>" },
  [pscustomobject]@{ BranchCode = "4172"; DisplayName = "4172-BackOrder-Update-ZBO"; WorkflowId = "<GUID>" },
  [pscustomobject]@{ BranchCode = "4173"; DisplayName = "4173-BackOrder-Update-ZBO"; WorkflowId = "<GUID>" }
)
