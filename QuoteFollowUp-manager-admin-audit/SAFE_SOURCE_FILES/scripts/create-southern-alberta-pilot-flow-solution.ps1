...
$branchSpecs = @(
  [pscustomobject]@{ BranchCode = "4171"; BranchSlug = "4171-calgary"; BranchName = "Calgary"; MailboxAddress = "<EMAIL>"; SharedMailboxFolderId = (Get-SouthernAlbertaSharedMailboxFolderId -BranchCode "4171"); SortOrder = 1; UsdOpsDailyRange = "'Daily Sales- Location'!A2:F500"; CadOpsDailyRange = "'Daily Sales- Location'!H2:M500" },
  [pscustomobject]@{ BranchCode = "4172"; BranchSlug = "4172-lethbridge"; BranchName = "Lethbridge"; MailboxAddress = "<EMAIL>"; SharedMailboxFolderId = (Get-SouthernAlbertaSharedMailboxFolderId -BranchCode "4172"); SortOrder = 2; UsdOpsDailyRange = $null; CadOpsDailyRange = "'Daily Sales- Location'!B2:G500" },
  [pscustomobject]@{ BranchCode = "4173"; BranchSlug = "4173-medicine-hat"; BranchName = "Medicine Hat"; MailboxAddress = "<EMAIL>"; SharedMailboxFolderId = (Get-SouthernAlbertaSharedMailboxFolderId -BranchCode "4173"); SortOrder = 3; UsdOpsDailyRange = $null; CadOpsDailyRange = "'Daily Sales- Location'!B2:G500" }
)
...
$templateSpecs = @(
  [pscustomobject]@{
    ...
    SourceFile = "QuoteFollow-UpImport-Staging_DEV-<GUID>.json"
  ...
  [pscustomobject]@{
    ...
    SourceFile = "BackOrder_Update_From_CA_ZBO_DEV-<GUID>.json"
  ...
  [pscustomobject]@{
    ...
    SourceFile = "Budget_Update_From_SA1300_Unmanaged_DEV-<GUID>.json"
...
function Update-QuoteFlow {
  ...
  foreach ($actionName in @("Update_Quote_Line", "Create_Quote_Line")) {
    ...
    Remove-PropertyIfPresent -Object $itemMap -Name "item/<EMAIL>"
...
<Workflow WorkflowId="{$workflowIdUpper}" Name="$FlowName" xmlns:xsi="<URL>>
...
$solutionXml = @"
<?xml version="1.0" encoding="utf-8"?>
<ImportExportXml version="9.2.26033.148" SolutionPackageVersion="9.2" languagecode="1033" generatedBy="CrmLive" xmlns:xsi="<URL> OrganizationVersion="9.2.26033.148" OrganizationSchemaType="Standard" CRMServerServiceabilityVersion="9.2.26033.00148">
  <SolutionManifest>
...
$customizationsXml = @"
<?xml version="1.0" encoding="utf-8"?>
<ImportExportXml xmlns:xsi="<URL> OrganizationVersion="9.2.26033.148" OrganizationSchemaType="Standard" CRMServerServiceabilityVersion="9.2.26033.00148">
  <Entities />
  <Roles />
  <Workflows />
...
$relationshipsXml = @"
<?xml version="1.0" encoding="utf-8"?>
<EntityRelationships xmlns:xsi="<URL> />
"@
