...
$flowCatalog = @(
  [pscustomobject]@{ DisplayName = "4171-Budget-Update-SA1300"; WorkflowId = "<GUID>" },
  [pscustomobject]@{ DisplayName = "4172-Budget-Update-SA1300"; WorkflowId = "<GUID>" },
  [pscustomobject]@{ DisplayName = "4173-Budget-Update-SA1300"; WorkflowId = "<GUID>" }
)
