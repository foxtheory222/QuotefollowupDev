...
$flowSpecs = @(
  [pscustomobject]@{
    ...
    WorkflowId = "<GUID>"
    TriggerMetadataId = "<GUID>"
    FilterMetadataId = "<GUID>"
    ComposeMetadataId = "<GUID>"
    RawDocumentMetadataId = "<GUID>"
    BatchMetadataId = "<GUID>"
  },
  [pscustomobject]@{
    BranchCode = "4172"
...
<Workflow WorkflowId="{$workflowIdUpper}" Name="$($Flow.FlowName)" xmlns:xsi="<URL>>
