...
$branchSpecs = @(
  [pscustomobject]@{ BranchCode = "4171"; BranchSlug = "4171-calgary"; RegionSlug = "southern-alberta"; MailboxAddress = "<EMAIL>"; EnableFeeds = $true },
  [pscustomobject]@{ BranchCode = "4172"; BranchSlug = "4172-lethbridge"; RegionSlug = "southern-alberta"; MailboxAddress = "<EMAIL>"; EnableFeeds = $true },
  [pscustomobject]@{ BranchCode = "4173"; BranchSlug = "4173-medicine-hat"; RegionSlug = "southern-alberta"; MailboxAddress = "<EMAIL>"; EnableFeeds = $true }
)
