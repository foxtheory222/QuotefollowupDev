...
$branchSpecs = @(
  [pscustomobject]@{ BranchCode = "4171"; BranchSlug = "4171-calgary"; BranchName = "Calgary"; MailboxAddress = "<EMAIL>"; SortOrder = 1; UsdOpsDailyRange = "'Daily Sales- Location'!A2:F500"; CadOpsDailyRange = "'Daily Sales- Location'!H2:M500" },
  [pscustomobject]@{ BranchCode = "4172"; BranchSlug = "4172-lethbridge"; BranchName = "Lethbridge"; MailboxAddress = "<EMAIL>"; SortOrder = 2; UsdOpsDailyRange = $null; CadOpsDailyRange = "'Daily Sales- Location'!B2:G500" },
  [pscustomobject]@{ BranchCode = "4173"; BranchSlug = "4173-medicine-hat"; BranchName = "Medicine Hat"; MailboxAddress = "<EMAIL>"; SortOrder = 3; UsdOpsDailyRange = $null; CadOpsDailyRange = "'Daily Sales- Location'!B2:G500" }
)
  ...
  $updateCurrentMonthBudgetAnalyticsPayload = [ordered]@{
    ...
    inputs = [ordered]@{
      parameters = [ordered]@{
        ...
        item = [ordered]@{
          qfu_opsdailycadjson = "@string(coalesce(body('Filter_CAD_Ops_Daily_Rows'), json('[]')))"
          qfu_opsdailyusdjson = "@string(coalesce(outputs('Filter_USD_Ops_Daily_Rows')?['body'], json('[]')))"
        }
      }
      host = [ordered]@{
        apiId = "/providers/Microsoft.PowerApps/apis/shared_commondataserviceforapps"
