...
- Site: `https://operationhub.powerappsportals.com/southern-alberta/`
...
- Direct route check against `https://operationhub.powerappsportals.com/southern-alberta/4171` returned `Page Not Found`, so verification for this change was completed against the live Southern Alberta regional page where the CSSR leaderboard is actively rendered.
